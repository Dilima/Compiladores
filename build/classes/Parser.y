...
%token IDENTIFICADOR STRING NUMERO TYPE
...
|   TK_NEW_VAR list_declaration ':' TYPE { $$ = new ASTDeclaration((ASTConcatenaIdentificadores)$2, new String(((Token)$4).getLexema())); }
;


list_declaration : /* declaraçao tipo, var a,b,c = int */
    list_declaration ',' list_declaration { $$ = new ASTConcatenaIdentificadores((ASTExpressao)$1,(ASTDeclaration)$3); }
|   IDENTIFICADOR { $$ = new ASTDeclaraVariavel(((Token)$1).getLexema()); }
;
