...
/**
 * Nó que representa a subtração entre 2 valores
 *
 * @author laerte
 */
public class ASTSubtracao extends ASTExpressao {

    public ASTSubtracao(ASTExpressao esquerda, ASTExpressao direita) {
