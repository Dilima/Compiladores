...
type
:	TK_INT 										{$$ = new ASTTipo(((Token)$1).getLexema()); System.out.println(":	TK_INT 										");}
|	TK_REAL										{$$ = new ASTTipo(((Token)$1).getLexema()); System.out.println("|	TK_REAL										");}
|	TK_BOOL										{$$ = new ASTTipo(((Token)$1).getLexema()); System.out.println("|	TK_BOOL										");}
;
...
|	'(' expr ')' {$$ = $2; System.out.println("|	'(' expr ')' ");}
